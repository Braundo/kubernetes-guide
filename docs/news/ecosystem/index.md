...
Ecosystem news filters cloud-native developments into platform-relevant signals for roadmap and architecture planning.
Only recent publications are listed here to keep ecosystem coverage actionable.

<!-- AUTO-LATEST:START -->
| Date | News | Summary |
| --- | --- | --- |
| 2026-03-28 | [KubeCon Europe 2026: What Came Out of Amsterdam](2026-03-28-kubecon-europe-2026-amsterdam-recap.md) | KubeCon Europe 2026 confirmed what many platform teams suspected: AI infrastructure is not a separate problem from Kubernetes. Kyverno graduated, Dapr Agents shipped v1.0, Istio added ambient multicluster and Inference Extension beta, and 66% of orgs are now running GenAI on Kubernetes. |
