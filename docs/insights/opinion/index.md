...
| --- | --- | --- |
| 2026-03-14 | [The Kubernetes Scheduler: Decision Loop, Plugin Architecture, and Operational Reality](2026-03-14-kubernetes-scheduler-decision-loop.md) | The Kubernetes scheduler is not a router. It is a continuous reconciler that applies a filtering and ranking pipeline to a cluster snapshot. Understanding its plugin architecture, control flow, and failure modes is essential for diagnosing placement problems. |
