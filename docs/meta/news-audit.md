...
| `news/releases/2025-09-01-kubernetes-v134-dra-has-graduated-to-ga.md` | Rewrite | Migrated to `updates/releases/2025-09-01-kubernetes-1-34-dra-ga.md`. |
...
| `news/releases/2025-09-09-kubernetes-v134-snapshottable-api-server-cache.md` | Rewrite | Migrated to `updates/releases/2025-09-09-kubernetes-1-34-api-server-cache.md`. |
...
| `news/releases/2025-09-12-kubernetes-v134-autoconfiguration-for-node-cgroup-driver-goe.md` | Rewrite | Migrated to `updates/releases/2025-09-12-kubernetes-1-34-cgroup-driver-ga.md`. |
| `news/security/2025-03-11-stopping-sobolan-malware-with-aqua-runtime-protection.md` | Rewrite | Migrated to `updates/security/2025-03-11-sobolan-jupyter-workload-risk.md`. |
| `news/security/2025-03-16-supply-chain-security-risk-github-action-tj-actionschanged-f.md` | Rewrite | Migrated to `updates/security/2025-03-16-cve-2025-30066-github-actions.md`. |
...
| `news/security/2025-03-26-ingressnightmare-vulnerabilities-all-you-need-to-know.md` | Rewrite | Migrated to `updates/security/2025-03-26-cve-2025-ingressnightmare-ingress-nginx.md`. |
...
| `news/ecosystem/2026-03-05-the-great-migration-why-every-ai-platform-is-converging-on-k.md` | Rewrite | Migrated to `updates/ecosystem/2026-03-ai-platforms-on-kubernetes-signals.md`. |
...
| `news/tool-radar/2025-12-16-productdevbookport-killer-a-powerful-cross-platform-port-man.md` | Rewrite | Migrated to `updates/tool-radar/2025-12-port-killer-devex-radar.md`. |
| `news/tool-radar/2025-12-17-alibabaopensandbox-opensandbox-is-a-general-purpose-sandbox-.md` | Rewrite | Migrated to `updates/tool-radar/2025-12-opensandbox-ai-sandbox-radar.md`. |
...
- High-signal pages were rewritten in structured templates under `updates/*`.
