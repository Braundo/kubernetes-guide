...
Release updates focus on operator impact: behavior changes, potential breakage, and upgrade validation priorities.
...
| 2025-09-01 | [Kubernetes v1.34 DRA Reaches GA](2025-09-01-kubernetes-1-34-dra-ga.md) | Dynamic Resource Allocation is GA in Kubernetes v1.34. What changes for platform teams running specialized hardware. |
<!-- AUTO-LATEST:END -->

## Related

- [Security updates](../security/index.md)
- [Ecosystem updates](../ecosystem/index.md)
